...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function validarEnBlanco() {
            var titulo = document.getElementById("txtTituloFalta").value;
            var categoria = document.getElementById("txtCategoria").value;
            var nActa = document.getElementById("txtNumeroActa").value;
            var plantilla = document.getElementById("cmbPlantilla").value;
            var contenido = FTB_API.FreeTextBox1.GetHtml();

            if (titulo == "" ||  categoria == "" || nActa == "" || plantilla == "" || contenido == "" ) 
            {
                    ...
                    <div class="side-content" style="margin:5px;">
                        ...
                        <h2 class="redtext">Imprimir Plantilla</h2>
                            ...
                            <div>
                                ...
                                <asp:Button ID="txtCambios" class="g-button" runat="server" onclick="txtCambios_Click"  OnClientClick="return validarEnBlanco();" style="margin-top:15px;"
                                Text="Ver Cambios" />
                                <style type="text/css">
                                    .FreeTextBox1_OuterTable {
                                        background-color: #FFFFFF;
